...
export default function MapLayerControl({ activeLayerName, onLayerSelect, heatmapEnabled = false, onHeatmapToggle }: MapLayerControlProps) {
          ...
          <div className="mt-2 bg-[#1a1a2e]/95 backdrop-blur-xl border border-white/[0.08] p-4 w-[300px] shadow-2xl shadow-black/50 rounded-2xl absolute right-4">
            ...
            <div className="mt-3 pt-3 border-t border-white/[0.06]">
              ...
              <button
                ...
                className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl border transition-all text-xs font-semibold ${
                  heatmapEnabled
